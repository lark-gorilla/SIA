...
ktest_16$tLength<-as.factor(ktest_16$tLength)
ktest_15$tLength<-as.factor(ktest_15$tLength)
ktest_04$tLength<-as.factor(ktest_04$tLength)

#Apply arcsine transformation
ktest_16$AS_bird_propz<-asin(sqrt(ktest_16$bird_propz))
ktest_15$AS_bird_propz<-asin(sqrt(ktest_15$bird_propz))
ktest_04$AS_bird_propz<-asin(sqrt(ktest_04$bird_propz))

k_16<-kruskal(ktest_16$AS_bird_propz, ktest_16$tLength, p.adj="bonferroni", console=T)

k_15<-kruskal(ktest_15$AS_bird_propz, ktest_15$tLength, p.adj="bonferroni", console=T)

k_04<-kruskal(ktest_04$AS_bird_propz, ktest_04$tLength, p.adj="bonferroni", console=T)
...
png("~/grive/phd/analyses/SIA/paper_plots/foraging_strat2.jpg", width = 9, height =9 , units ="in", res =600)

grid.arrange(pp_04, pp_15, pp_16, ncol=1,nrow=3,
