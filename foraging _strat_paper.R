...
lhi_16<-foragingStrat(nest_comp=nest_comp_lhi16, D1="2016-02-05"
                      ,D2="2016-03-12" , longallow=TRUE, Nruns=100, remUnknowns=FALSE)
...
n_agg<-data.frame(aggregate(RW_corr~NestID, nest_comp_lhi15, FUN=function(x){table(x)})[,1],
                      aggregate(RW_corr~NestID, nest_comp_lhi15, FUN=function(x){table(x)})[,2])
names(n_agg)[1]<-"ID"

l_5<-n_agg[n_agg$D<6,]$ID

nest_comp_lhi15<-nest_comp_lhi15[nest_comp_lhi15$NestID %in% l_5,]

D1="2015-02-18"
D2="2015-03-18"

lhi_15<-foragingStrat(nest_comp=nest_comp_lhi15, D1="2015-02-18"
                      ,D2="2015-03-12" , longallow=TRUE, Nruns=100, remUnknowns=FALSE)

lhi_15RU<-foragingStrat(nest_comp=nest_comp_lhi15, D1="2015-02-18"
                        ,D2="2015-03-18" , longallow=TRUE, Nruns=1, remUnknowns=TRUE)
...
lhi_04<-foragingStrat(nest_comp=nest_comp_lhi04, D1="2004-02-05"
                      ,D2="2004-02-28" , longallow=TRUE, Nruns=100, remUnknowns=FALSE)

lhi_04RU<-foragingStrat(nest_comp=nest_comp_lhi04, D1="2004-02-05"
